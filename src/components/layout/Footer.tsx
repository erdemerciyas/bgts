...
export default function Footer() {
    return (
        <footer className="bg-corporate-primary text-white pt-20 pb-10">
            <div className="container mx-auto px-6">

                {/* Top Section: Logo & Newsletter/CTA */}
                <div className="flex flex-col md:flex-row justify-between items-start mb-16 border-b border-corporate-primary/50 pb-12">
                ...
                {/* Bottom Bar */}
                <div className="pt-8 border-t border-corporate-primary/50 flex flex-col md:flex-row justify-between items-center gap-4">
                    <p className="text-white/50 text-sm">
                        © 2024 BGTS. Tüm hakları saklıdır.
                    </p>
                    <div className="flex gap-6">
                        <Link href="#" className="p-2 bg-corporate-primary rounded-full hover:bg-corporate-secondary transition-colors text-white">

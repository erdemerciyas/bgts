export const STYLES = {
    ...
    megaMenuWrapperAnalyses: "absolute top-0 left-1/2 -translate-x-1/2 w-[1080px] max-w-[92vw] bg-white shadow-2xl rounded-b-xl border-t border-gray-100 ring-1 ring-black/5 overflow-hidden z-50 mega-menu-scale",

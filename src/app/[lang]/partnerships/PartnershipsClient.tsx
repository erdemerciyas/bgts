...
const PARTNERS_CONFIG = [
    ...
    },
    {
        ...
        color: "from-[#087ef6] to-[#4fa3ff]",
    },
]

export default function PartnershipsClient({ dict: d }: { dict: PartnershipsDict }) {
    return (
            ...
            <section className="py-20">
                <Container>
                    <StaggerContainer className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {PARTNERS_CONFIG.map((conf, index) => {
                            const p = d.items[conf.slug]
                            return (
                                <StaggerItem
                                    key={index}
                                ...
                                >
                                    <div className={`w-20 h-20 rounded-2xl bg-gradient-to-br ${conf.color} flex items-center justify-center text-white mb-6 shadow-lg shadow-current/20 group-hover:scale-110 transition-transform duration-300`}>
                                        {conf.icon}
                                    </div>

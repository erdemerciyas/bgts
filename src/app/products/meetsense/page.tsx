...
export default function MeetSensePage() {
    return (
        <div className="bg-white min-h-screen">
            ...
            {/* ═══════════ HERO ═══════════ */}
            <div className="relative pt-32 pb-32 overflow-hidden bg-slate-950">
                {/* Decorative Gradients */}
                <div className="absolute top-[-20%] left-[-10%] w-[600px] h-[600px] bg-indigo-600 rounded-full blur-[150px] opacity-20 pointer-events-none" />
                <div className="absolute bottom-[20%] right-[-10%] w-[600px] h-[600px] bg-fuchsia-600 rounded-full blur-[150px] opacity-20 pointer-events-none" />

                <Container className="relative z-10">
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        <motion.div initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.6 }}>
                            <div className="inline-block bg-indigo-500/20 text-indigo-300 font-bold px-4 py-1.5 rounded-full text-sm border border-indigo-400/30 mb-6 backdrop-blur-sm">
                                YENİ NESİL AI PLATFORMU
                            </div>
                            <h1 className="text-5xl lg:text-7xl font-bold text-white leading-tight mb-6">
                                Meet<span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-cyan-400">Sense</span>
                            </h1>
                            ...
                            <div className="flex flex-wrap gap-4">
                                <Link href="/contact" className="px-8 py-4 bg-indigo-600 text-white font-bold text-lg rounded-full hover:bg-indigo-700 hover:-translate-y-1 transition-all shadow-[0_8px_30px_rgb(79,70,229,0.3)]">
                                    Demo Talep Edin
                                </Link>
                                <Link href="#features" className="px-8 py-4 bg-white/5 backdrop-blur text-white font-bold text-lg rounded-full border border-white/10 hover:bg-white/10 transition-all">
                                    Özellikleri İncele
                                </Link>
                            </div>
                        </motion.div>
                        ...
                        <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} transition={{ delay: 0.2, duration: 0.8 }} className="relative">
                            ...
                            <img
                                ...
                                className="w-full h-auto rounded-xl border border-white/10 shadow-[0_20px_50px_rgba(0,0,0,0.5)] relative z-0"
                            />
                        </motion.div>
                    </div>
                </Container>

...
import { Code2, Database, Layout, Smartphone, Zap, Cpu, ShieldCheck, GitBranch, PlayCircle, Server, Rocket, Heart, Timer, Award, Globe, Coffee, Terminal } from "lucide-react"
    ...
    return (
        <>
            <div className="bg-white min-h-screen">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="grid md:grid-cols-2 gap-6 mt-8">
                                <div className="bg-blue-50 p-6 rounded-xl border-2 border-blue-200">
                                    ...
                                    <Text variant="muted" className="text-slate-600">Java, .NET Core, Go, ve Node.js ile güçlü altyapılar.</Text>
                                </div>
                                <div className="bg-indigo-50 p-6 rounded-xl border-2 border-indigo-200">
                                    <h4 className="font-bold text-slate-900 mb-3 flex items-center gap-2">
                                        <Globe className="w-5 h-5 text-indigo-600" /> Frontend
                                    </h4>
                                    <Text variant="muted" className="text-slate-600">React, Vue, Angular ve Next.js ile modern arayüzler.</Text>
                                </div>
                            </div>
                        </div>
                    }
                        ...
                        <div className="relative h-full min-h-[400px] rounded-2xl overflow-hidden">
                            ...
                            <div className="absolute inset-0 bg-gradient-to-br from-blue-900/80 to-indigo-900/80 flex items-center justify-center">
                                <div className="text-center text-white p-8">
                                    ...
                                    <Heading variant="h4" className="text-4xl font-bold mb-2 text-white">Modern Stack</Heading>
                                    <Text className="text-blue-100 text-xl">En güncel teknolojiler</Text>
                                </div>
                            </div>
                        </div>
                    }
                        ...
                        <div className="relative h-full min-h-[400px] rounded-2xl overflow-hidden">
                            ...
                            <div className="absolute inset-0 bg-gradient-to-br from-indigo-900/80 to-blue-900/80 flex items-center justify-center">
                                <div className="text-center text-white p-8">
                                    ...
                                    <Heading variant="h4" className="text-4xl font-bold mb-2 text-white">Mobil Öncelikli</Heading>
                                    <Text className="text-blue-100 text-xl">Her platformda kusursuz deneyim</Text>
                                </div>
                            </div>
                        </div>
                    }
                ...
                <Section>
                    <Container>
                        <Heading variant="h2" className="text-center mb-12">Teknoloji Yığınımız</Heading>
                        <TechStackGrid
                            items={[
                                // Frontend

    ...
    pillars: [
        {
            ...
            overview: {
                ...
                model: {
                    ...
                    description: "MSP hizmet modeli kapsamında BGTS Yönetilen Hizmetler; teknik operasyonları dışarıdan yönetmekle sınırlı kalmaz. Altyapınızı tanımayı, süreçlerinizi geliştirmeyi ve kurumunuzun büyümesine paralel ölçeklenmeyi hedefler. İş birliğinin başlangıcında; alarm kalitesi, olay müdahalesi, otomasyon olgunluğu, gözlemlenebilirlik kapsamı ve SRE hazırlığı gibi alanlar ön değerlendirmeyle ele alınır, elde edilen bulgular yönetsel ve teknik ekiplerinizle paylaşılır."
                },

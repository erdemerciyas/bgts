...
- **Modal detay görünümü** (`ArticleModal.tsx`) — Markdown render, klavye erişilebilirlik (ESC, focus trap), viewport'a sığan flex layout (`max-h-[90dvh]`), kapak görseli tam oranında gösterim, içerik alanında dahili scroll
...
- **ArticleModal:** Portal tabanlı makale detay modalı — kapak banner, meta satırı, Markdown gövde, scroll lock

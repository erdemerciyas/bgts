...
- **Mega Menu Navigasyon:** Hizmetler, Ürünler, Sektörler ve Bilgi Merkezi için tam genişlikte mega menüler; Bilgi Merkezi sol panelinde EBINTEC etkinlik kartı, son makale ve rastgele makale karuseli (`ResourcesMenuLeftPanel.tsx`); "Yerini Al" ve "Hakkımızda" doğrudan nav linkleri
...
- **Modal detay görünümü** (`ArticleModal.tsx`) — Markdown render, klavye erişilebilirlik (ESC, focus trap), viewport'a sığan flex layout; kapak görseli, başlık/meta ve makale gövdesi tek scroll alanında; mobilde kompakt tipografi ve padding
...
│   │   │   │   ├── infographics/
│   │   │   │   ├── success-stories/
│   │   │   │   └── articles/       # Makaleler sayfası (ArticlesClient, ArticlesHero, ArticleModal)
│   │   │   │
...
- **ResourcesMenuLeftPanel:** Bilgi Merkezi mega menüsü sol paneli — EBINTEC etkinlik kartı, en son makale linki (`?article=` deep link), rastgele 3'lü makale karuseli (5 sn otomatik geçiş, hover'da duraklama)
...
- **ArticleModal:** Portal tabanlı makale detay modalı — kapak banner, meta satırı, Markdown gövde; tüm içerik tek scroll konteynerinde, scroll lock
